...
const HomeCircle = () => {
    return (
        <ul className='flex gap-[2.3vw]'>
            <div>
                <li className='bg-gray-100 w-28 h-28 p-7 rounded-full hover:border-8 border-gray-400'>
                    <FaUserDoctor className='w-12 h-12' />
                </li>
                <h2 className='flex-row mx-2'>Examination</h2>
            </div>
            <div>
                <li className='bg-gray-100 w-28 h-28 p-7 rounded-full hover:border-8 border-gray-400'>
                    <GiMedicinePills className='w-12 h-12' />
                </li>
            ...
            <div>
                <li className='bg-gray-100 w-28 h-28 p-7 rounded-full hover:border-8 border-gray-400'>
                    <GiCorkedTube className='w-12 h-12' />
                </li>
