                ...
                <div>
                   {/* <div className={'flex w-[100%] h-[900px] bg-gradient-to-r from-[#21cdc0] to-[#213360]'}>
                        <div className={'flex-col items-center justify-center mx-10 space-y-8 p-6 m-4 text-[white]'}>
                            <p className={'font-bold text-3xl mx-10'}>
...
*/}
                    <div className={'flex  bg-gradient-to-r from-[#21cdc0] to-[#213360]'}>
                        <div className={'flex-col w-[100%] h-[930px] items-center justify-center mx-40 '}>
                            <h1 className={'text-4xl font-bold text-[#213360] my-2 p-8'}>Meet Our Doctors</h1>
                            <p className={'text-xl font-bold text-[#213360] p-6'}>
                    ...
                    {/*        <p className={'text-3xl font-bold text-[#213360] mx-17'}>*/}
